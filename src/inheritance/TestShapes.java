...
public class TestShapes {
    public static void main(String[] args) {
        //test inheritance
        System.out.println("Testing inheritance methods (QL3)");
        ...
        System.out.println("");
        System.out.println("Testing interface methods (QL4)");
        Circle circle1 = new Circle ("circle1", "red", 0,0, 10);
        Circle circle2 = new Circle ("circle2", "blue", 10,10, 5);

        //print out the objects
        System.out.println(circle1);
        System.out.println(circle2);
        System.out.println("Circle location before move: " + circle1.getCurrentLocation());
        c.move(10.5, 4.3);
